        ...
        <div class="card shadow border-0">
            ...
            <div class="card-body" :class="{'is-fetching': isFetching}">
                ...
                <div class="row mt-3 no-gutters">
                    ...
                    <div v-if="empreendimento_selected" class="col text-right">
                        <button :disabled="vinculacao" class="btn btn btn-success" data-toggle="modal" data-target="#modalNovaVinculacao"><i class="fas fa-plus"></i> Adicionar</button>
                    </div>
                </div>
            </div>
        </div>
