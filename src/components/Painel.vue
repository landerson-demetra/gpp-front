<template>
    <div id="painel" class="wow fadeIn" data-wow-duration="2s">
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="content-gest mb-5" :class="{ 'col-md-9': !gestExpanded, 'col-md-12': gestExpanded }">
                    <div class="card shadow border-0">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <button class="btn btn-primary" type="button">Administração</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-2">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">IPTUs</a>
                                </li>
                            </ul>
...
export default {
  ...
  data() {
    return {
        ...
        historicos: {
            ...
            tblClass: 'table-borderless table-sm',
            columns: [
        ...
        condominios: {
            fixHeaderAndSetBodyMaxHeight: 160,
            tblClass: 'table-borderless table-sm border border-top-0',
            columns: [
                { title: 'Status', field: 'status', sortable: true},
  ...
  components: { GppHeader, GppResumo },
