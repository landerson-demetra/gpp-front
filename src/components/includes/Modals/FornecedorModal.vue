            ...
            <div class="modal-dialog modal-lg shadow" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" v-on:submit.prevent="updateFornecedor()">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <input v-model="cpf_cnpj" id="cpf_cnpj" name="cnpj_cpf" type="text" placeholder="CNPJ/CPF do fornecedor..." class="form-control" required="">
                                </div>
                                <div class="form-group col-lg-3">
                                ...
                                <div class="form-group col-lg-4">
                                   ...
                                   <input v-model="CEP" :class="{'is-invalid': CEPHasError}" type="text" placeholder="CEP..." class="form-control">
                                </div>
                                <div class="form-group col-lg-4">
...
export default {
    ...
    methods: {
        emitOkEvent(){
            this.getFields.action = this.action

            Bus.$emit(this.name + '-onOk', this.getFields)
        },
        assignCepValues(r){
            if(r.resultado == 0){
